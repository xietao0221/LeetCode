...
public class Solution {
    public String minWindow(String s, String t) {
        int[] charSet = new int[256];       // the character set of String t
        ...
        for(int i = 0; i < t.length(); i++) charSet[tArray[i]]++;
        ...
        while(end < sArray.length) {
            ...
            while(count == 0) {
                ...
                if(++charSet[sArray[begin++]] > 0) count++;
            }
        }
